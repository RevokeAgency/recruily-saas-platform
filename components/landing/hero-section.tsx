  ...
  return (
    <section className="rv relative overflow-hidden bg-white pt-32 pb-20 lg:pt-40 lg:pb-28">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 sm:px-6 lg:grid-cols-2 lg:px-8">
        {/* Left copy */}
        <div>
          <span className="rv-fade-up inline-flex items-center gap-2 rounded-full border border-[#E5E9E7] bg-[#EBF7F9] px-4 py-1.5 font-sans text-xs font-medium text-[#3F4A45]">
            <span className="h-2 w-2 rounded-full bg-[#4EB0BE]" />
            250+ recruiting teams trust REVETLY
          </span>

          <h1 className="rv-fade-up rv-delay-1 mt-6 font-sans text-4xl font-bold leading-[1.08] tracking-tight text-[#081314] text-balance sm:text-5xl lg:text-6xl">
          ...
          <div className="rv-fade-up rv-delay-3 mt-8 flex flex-wrap items-center gap-3">
            <Link
              href="/auth/register"
              className="inline-flex items-center gap-2 rounded-full bg-[#4EB0BE] px-6 py-3.5 font-sans text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-[#2B6169] hover:shadow-md"
            >
              Start Free
            ...
            <a
              href="#how-it-works"
              className="inline-flex items-center gap-2 rounded-full border border-[#E5E9E7] bg-white px-6 py-3.5 font-sans text-sm font-semibold text-[#081314] transition-all duration-200 hover:border-[#4EB0BE] hover:text-[#4EB0BE]"
            >
              See How it Works
        ...
        <div className="rv-fade-up rv-delay-2 relative mx-auto w-full max-w-md">
          <div className="relative rounded-3xl bg-[#081314] p-7 pr-32 text-white shadow-xl">
            <p className="font-sans text-2xl font-bold leading-tight">
              Successfully connected over 1,000 businesses with top talent.
            </p>
            <p className="mt-4 max-w-[14rem] font-sans text-xs leading-relaxed text-[#7AABB2]">
          ...
          <div className="rv-float absolute -right-1 -top-10 w-44 overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/5 sm:w-48">
            <div className="relative">
              ...
              />
              <span className="absolute left-2 top-2 inline-flex items-center gap-1 rounded-full bg-white/95 px-2.5 py-1 font-sans text-[10px] font-semibold text-[#081314] shadow-sm">
                <Star className="h-3 w-3 fill-[#4EB0BE] text-[#4EB0BE]" />
                Top rated platform
              </span>
            </div>
            <div className="p-3">
              <p className="font-sans text-sm font-bold text-[#081314]">Sarah Mitchell</p>
